...
const createBattlefieldRow = forwardRef((props, ref) => {
  ...
  return html`<div id="${playerSpecificData.identifier}-cards-battle" className="z-0 flex flex-row items-center justify-center flex-auto w-full h-full preserve-3d">
