...
const Game = forwardRef((props, ref) => {
  ...
  return html`
  <canvas id="drawContainer" data-line-drawer-target="canvas" width="0" height="0" className='fixed bottom-0 left-0 right-0 z-50 mx-auto pointer-events-none select-none bg-rose-500 opacity-40'></canvas>
  <div id="inner-game-container" className="absolute bottom-0 w-full max-w-[1920px] h-full h-[123.5vh] mx-auto right-0 left-0 my-auto children-in-game-perspective">
  ...
  className="flex flex-col content-between justify-between w-full h-full max-h-[1600px] mx-auto items-between flex-nowrap gap-y-6 xl:gap-y-2 game-perspective-3d overflow-clip bg-light-brown"
