...
const cardInHandClassList = 'relative inline-block w-40 -mt-12 -ml-10 text-white border-2 border-blackish rounded h-48 max-h-60 bg-card-blue preserve-3d';
const containerClasslist = 'absolute flex-1 w-full ml-auto text-center has-tooltip shrink flex-nowrap whitespace-nowrap -top-16 children-in-game-perspective';
