...
const classList = 'absolute bottom-0 z-10 stat-bubble w-12 h-12 pb-1 mt-1 text-4xl text-center border-2 rounded-full pointer-events-none select-none health-current border-lime-600 bg-lime-500 right-0';
